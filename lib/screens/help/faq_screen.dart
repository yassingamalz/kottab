      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: const [
            ...
            FAQItem(
              question: 'ما هو تطبيق كتّاب؟',
              answer: 'كتّاب هو تطبيق مصمم لمساعدة المسلمين في حفظ القرآن الكريم بطريقة منظمة وفعالة. يستخدم التطبيق نظام المراجعة المتباعدة لتعزيز الحفظ على المدى الطويل.',
            ),

            FAQItem(
              question: 'هل التطبيق مجاني؟',
              answer: 'نعم، تطبيق كتّاب مجاني بالكامل، ويمكن استخدام جميع الميزات دون الحاجة لدفع أي رسوم.',
            ),
